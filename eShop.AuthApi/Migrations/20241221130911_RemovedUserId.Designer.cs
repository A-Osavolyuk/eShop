...
namespace eShop.AuthApi.Migrations
{
    ...
    [Migration("20241221130911_RemovedUserId")]
            ...
            modelBuilder.Entity("eShop.Domain.Entities.AuthApi.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "76ab2d19-549f-42b1-8ac9-7e5e34734bd1",
                            ...
                            SecurityStamp = "7d5689e1-6463-44d6-b7a8-2d7c1fb305f1",
            ...
            modelBuilder.Entity("eShop.Domain.Entities.AuthApi.PersonalDataEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("0c193a62-62f8-4f6f-8363-a967813f0f0f"),
