...
namespace eShop.AuthApi.Migrations
{
    ...
    [Migration("20241221124104_RemovedCodeTypeAndSessionIdFields")]
    partial class RemovedCodeTypeAndSessionIdFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eShop.Domain.Entities.AuthApi.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "5cf51e63-54f5-4b09-be99-0256c93564ed",
                            ...
                            SecurityStamp = "ef72f6c6-6978-4066-8eda-de20374e83cf",
            ...
            modelBuilder.Entity("eShop.Domain.Entities.AuthApi.PersonalDataEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("46f76abd-01a5-4978-85d6-9eb7390f0bb8"),
