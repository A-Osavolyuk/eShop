...
public class VerifyNewEmailConsumer(IEmailService emailService) : IConsumer<NewEmailVerificationMessage>
{
        ...
        string body = $"""
                       ...
                       <html lang="en">
                         <head>
                           ...
                           <title>Email change (step two)</title>
                         </head>
                         <body>
                           <div
                             style="border: 1px solid rgb(190, 189, 189); width: 800px; margin: auto; padding: 1px;">
                             <div>
                               <p style="font: bold 24px Arial, sans-serif; color: rgb(141, 66, 212); margin: 30px; text-align: center;">
                                 eShop Team
                               </p>
                             </div>
                             ...
                             <div style="padding: 50px 100px; margin: auto">
                               ...
                               <br />
                               <p style="font: 16px Arial, sans-serif; margin: 0">
                                 We have received a request to change your current email address to
                                 this one. To verify your new email address, please enter the code
                                 below.
                               </p>
                               <br />
                               <p style="font: 16px Arial, sans-serif; margin: 0">
                                 Your verification code: {code}. Will expire in: 10 mins.
                               </p>
                               <br />
                               <p style="font: 16px Arial, sans-serif; margin: 0">
                               ...
                               <p style="font: 14px Arial, sans-serif; margin: 40px 0">
