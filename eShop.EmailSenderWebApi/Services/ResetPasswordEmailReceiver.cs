...
{
    public class ResetPasswordEmailReceiver(IOptions<EmailOptions> _options) : IConsumer<SendResetPasswordEmailRequest>
    {
        private readonly EmailOptions options = _options.Value;

        public async Task Consume(ConsumeContext<SendResetPasswordEmailRequest> context)
        {
