...
namespace eShop.AuthWebApi.Migrations
{
    ...
    [Migration("20241017095823_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eShop.Domain.Entities.Admin.Permission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("eShop.Domain.Entities.Admin.PersonalData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f9ebf56f-c732-46ab-9db2-23904e391ad1"),
            ...
            modelBuilder.Entity("eShop.Domain.Entities.Admin.UserPermissions", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("eShop.Domain.Entities.Auth.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e87836b3-62c5-493f-b3e4-8f5c08799d7d",
                            ...
                            SecurityStamp = "ac3af021-6021-419a-8943-dc3595e75db8",
                            TwoFactorEnabled = false,
                            UserName = "sasha.osavolll111@gmail.com"
                        });
                });

            modelBuilder.Entity("eShop.Domain.Entities.Auth.UserAuthenticationToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("eShop.Domain.Entities.Auth.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("eShop.Domain.Entities.Admin.UserPermissions", b =>
                {
                    b.HasOne("eShop.Domain.Entities.Admin.Permission", "Permission")
            ...
            modelBuilder.Entity("eShop.Domain.Entities.Auth.UserAuthenticationToken", b =>
                {
                    b.HasOne("eShop.Domain.Entities.Auth.AppUser", "User")
                        ...
                        .HasForeignKey("eShop.Domain.Entities.Auth.UserAuthenticationToken", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
